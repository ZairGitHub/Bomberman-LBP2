...
This update would have also seen the removal of Remote Bombs. I initially added Remote Bombs to the game as I wanted to experiment with their viability in online play. Many Bomberman games feature the Remote Bombs in their single-player campaigns yet mysteriously omit them from their multiplayer experiences. I now understand that this is a deliberate balancing decision as the ability to leave behind bombs that only detonate on demand (if not hit by the fire of another bomb) is not only overwhelming for opposing players but it also takes away from the strategic positioning of the core Bomberman experience. Remote Bombs would have been replaced by the Pierce Bomb. This special bomb transforms the apperance of all of the player's bombs, modifies the colour of their fire (to signify the change in its fire properties), and has the fire travel through and destroy any collided soft blocks and power-ups where it is only stopped if it collides with a hard block. This special bomb is more commonplace in Bomberman games and is a far more balanced and acceptable alternative to the overpowered Remote Bomb.
